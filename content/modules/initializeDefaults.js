...
window.LeadManagerPro.modules.initializeDefaultOptions = function() {
  ...
  try {
    ...
    const existingGroupOptions = localStorage.getItem('snap_lead_manager_group_options');
    if (!existingGroupOptions) {
      localStorage.setItem('snap_lead_manager_group_options', JSON.stringify(defaultGroupOptions));
